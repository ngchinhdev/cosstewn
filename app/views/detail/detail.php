    ...
    <div class="row">
        ...
        <div class="col-12 d-flex col-lg-6">
            <div class="list-imagedetail">
                <img src="../../public/app/imgs/anh1-productdetail.webp" alt="" class="active">
                <img src="../../public/app/imgs/anh2-productdetail.webp" alt="">
                <img src="../../public/app/imgs/anh3-productdetail.webp" alt="">
                <img src="../../public/app/imgs/anh4-productdetail.webp" alt="">
            </div>
            <div class="wrapper-image d-flex justify-content-center align-items-center">
                <img src="../../public/app/imgs/anh1-productdetail.webp" alt="">
            </div>
        </div>
        <div class="col-12 col-lg-6 mt-sm-3 mt-lg-0">
            <div class="brand_name my-2">CLUB CLIO</div>
            <div class="name_product">
                <h1>Phấn Nước Che Khuyết Điểm Hoàn Hảo Clio Kill Cover The New Founwear Cushion
                    SPF50+ PA+++ (15gx2) (Tặng 1 lõi refill)</h1>
            </div>
            <div class="wrap-price d-flex align-items-baseline">
                <div class="price-now">778.050đ</div>
                <div class="price-origin">819.000đ</div>
                <div class="sale">
                    <div class="text-sale">-25%</div>
                </div>
            </div>
