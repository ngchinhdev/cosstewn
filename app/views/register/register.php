<div id="container_login" class="container">
    <div class="register">
        ...
        <form action="registerController/registerController.php" method="post">
            <div class="ho-ten">
            ...
            <div class="pass">
                <div class="form-group">
                    ...
                    <input type="password" id="mat-khau" name="pass" placeholder="Mật khẩu" required>
                </div>
                <div class="form-group">
                    <label for="nhap-lai-mat-khau">Nhập lại mật khẩu <span class="star">*</span></label>
                    <input type="password" id="nhap-lai-mat-khau" name="repass" placeholder="Nhập lại mật khẩu" required>
                </div>
            </div>
            <div class="address">
                <div class="form-group">
