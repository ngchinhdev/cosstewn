                    ...
                    <a href="" class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <g clip-path="url(#clip0_741_1547)">
                                <path d="M2.11 11.6L1.16 15.7C1.12723 15.8499 1.12836 16.0052 1.16329 16.1546C1.19823 16.304 1.2661 16.4437 1.36194 16.5635C1.45778 16.6833 1.57917 16.7801 1.71724 16.847C1.85532 16.9139 2.00659 16.9491 2.16 16.95C2.23149 16.9572 2.30352 16.9572 2.375 16.95L6.5 16L14.42 8.11L10 3.7L2.11 11.6Z" fill="black" fill-opacity="0.6" />
                                <path d="M16.91 4.16L13.96 1.21C13.766 1.01703 13.5036 0.908707 13.23 0.908707C12.9564 0.908707 12.6939 1.01703 12.5 1.21L10.86 2.85L15.275 7.265L16.915 5.625C17.011 5.52854 17.087 5.4141 17.1387 5.28823C17.1904 5.16236 17.2167 5.02753 17.2163 4.89146C17.2158 4.75539 17.1885 4.62075 17.136 4.49523C17.0834 4.36972 17.0066 4.2558 16.91 4.16Z" fill="black" fill-opacity="0.6" />
                            </g>
                            <defs>
                ...
                <div class="items_row">
                    <div class="item d-flex justify-content-between align-items-center">
                        <div class="item_info d-flex align-items-center">
                            <img src="../../public/app/imgs/bf7aac2f-02b9-42aa-8106-2f97d758f4a7.webp" alt="" class="me-3 img_prod">
                            <div class="name">
                                <b>KLARIS</b>
                                <p style="font-size: 13px;" class="mb-2">Nước Hoa Hồng Klaris Không Mùi Cho Da Nhạy Cảm 180ml</p>
                                <span>x1</span>
                            </div>
                        </div>
                        <div class="item_price">
                            <del>409.000 đ</del><strong>266.000 đ</strong>
                        </div>
                    </div>
                </div>
                <div class="bill_sumary d-flex justify-content-end">
                    ...
                    <span>Thành tiền: </span><strong>555.555 đ</strong>
                </div>
            </div>
        </div>
    </div>
