    ...
    <div class="row">
        <div class="left_site px-4 py-3 col-lg-3">
            <div class="info_box d-flex align-items-center">
                <div class="avt">
                    <?php $link = isset($_SESSION['avatar']) && str_contains($_SESSION['avatar'], 'http') ? $_SESSION['avatar'] : '../../public/app/imgs/'.$_SESSION['avatar'] ?>
                ...
                <div class="name">
                    ...
                    <a href="index.php?page=ho-so" class="change_profile d-flex align-items-center">
            ...
            <ul class="nav mt-3 w-100">
                <li class="w-100">
                    <a href="index.php?page=ho-so&u=<?= $_SESSION['user_id'] ?>" class="w-100 d-inline-block p-2 rounded-2 <?php echo isset($_GET['page']) && $_GET['page'] === 'ho-so' ? 'active' : ''; ?>">
                ...
                <li class="mt-2 w-100">
                    <a href="index.php?page=lich-su-mua&u=<?= $_SESSION['user_id'] ?>&status=all" class="w-100 d-inline-block p-2 <?php echo isset($_GET['page']) && $_GET['page'] === 'lich-su-mua' ? 'active' : ''; ?> rounded-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
        ...
        <div class="right_site col-lg-9">
            <div class="prof_info px-4 py-3">
                ...
                <form class="row mt-4" enctype="multipart/form-data" action="../controllers/profileController/profileController.php" method="post">
                    <div class="col-lg-8 px-5 border-end">
                        <table class="px-4 w-100">
                            <tr class="align-items-center">
                                <td class="text-end me-3 pe-5">Họ tên: </td>
                                <td>
                                    <input class="w-100 border-bottom" value="<?= $cur_user['ho_ten'] ?>" type="text" name="name" id="">
                                </td>
                            </tr>
                            <tr class="align-items-center">
                                <td class="text-end me-3 pe-5">Email: </td>
                                <td>
                                    <input class="w-100 border-bottom" value="<?= $cur_user['email'] ?>" type="text" name="email" id="">
                                </td>
                            </tr>
                            <tr class="align-items-center">
                        ...
                        <input type="submit" name="save" value="Lưu" class="py-2 px-3 mt-3 rounded-2">
                    </div>
                    <div class="col-lg-4 d-flex flex-column align-items-center pt-3">
                        <?php $link = isset($_SESSION['avatar']) && str_contains($_SESSION['avatar'], 'http') ? $_SESSION['avatar'] : '../../public/app/imgs/'.$_SESSION['avatar'] ?>
                        <img src="<?= isset($_SESSION['avatar']) && $_SESSION['avatar'] ? $link : 'https://inkythuatso.com/uploads/thumbnails/800/2023/03/9-anh-dai-dien-trang-inkythuatso-03-15-27-03.jpg' ?>" alt="Avatar" class="rounded-circle me-3">
                        <input type="file" class="d-none" id="file-avt" name="avatar">
                        <label for="file-avt" role="button" class="d-inline-block mt-4 border py-2 px-3 rounded-2">Chọn ảnh</label>
                    </div>
                </form>
            </div>
        </div>
