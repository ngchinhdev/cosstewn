                ...
                <div class="above_header d-flex justify-content-between align-items-center">
                    ...
                    <div class="right_above d-flex align-items-center position-relative">
                        ...
                        <div class="login_header log_cart <?php echo isset($_GET['page']) && ($_GET['page'] === 'dang-nhap' || $_GET['page'] === 'ho-so') ? 'active' : ''; ?>">
                            <a href="index.php?page=<?php echo (isset($_COOKIE['user_id']) || isset($_GET['u'])) ? 'ho-so&u='.($_COOKIE['user_id'] ?? $_GET['u']) : 'dang-nhap' ?>" class="">
                                ...
                                <span class="d-none d-xl-inline-block"><?php echo (isset($_COOKIE['user_id']) || isset($_GET['u'])) ? 'Hồ sơ' : 'Đăng nhập' ?></span>
                            </a>
                        </div>
                        <div class="cart_header ms-2 ms-xl-4 justify-self-end position-relative log_cart <?php echo isset($_GET['page']) && $_GET['page'] === 'gio-hang' ? 'active' : ''; ?>">
                            <a href="index.php?page=<?= (isset($_COOKIE['user_id']) || isset($_GET['u'])) ? 'gio-hang' : 'dang-nhap' ?>">
                                ...
                                <span class="position-absolute num_in_cart"><?php if ((isset($_COOKIE['user_id']) || isset($_GET['u']))) {
                                                                                if ($totalQuantity > 0) {
                                                                                    echo $totalQuantity;
                                                                                } else if ($totalQuantity < 1) {
                                                                                    echo 0;
                                                                                }
                                                                            } else if (!(isset($_COOKIE['user_id']) || isset($_GET['u']))) {
                                                                                echo 0;
                                                                            } ?></span>
                            </a>
                        </div>
